...
export default class Arabian implements ICalendarEntities {
    ...
    longHalfYears: string[] = ['نصف عام I', 'نصف عام II '];
    shortHalfYears: string[] = ['نصف عام I', 'نصف عام II '];
    ...
    shortQuarters: string[] = ['I ربع سنة', 'II ربع سنة', 'III ربع سنة', 'IV ربع سنة'];
    minQuarters: string[] = ['I ربع سنة', 'II ربع سنة', 'III ربع سنة', 'IV ربع سنة'];
    today: string = 'اليوم';
