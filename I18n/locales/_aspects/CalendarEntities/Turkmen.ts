...
export default class Turkmen implements ICalendarEntities {
    ...
    longHalfYears: string[] = ['I ýarym ýyl', 'II ýarym ýyl'];
    shortHalfYears: string[] = ['I ýa', 'II ýa'];
    ...
    shortQuarters: string[] = ['I çär', 'II çär', 'III çär', 'IV çär'];
    minQuarters: string[] = ['I çä', 'II çä', 'III çä', 'IV çä'];
    today: string = 'Bu gün';
