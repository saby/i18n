...
export default class Russian implements ICalendarEntities {
    ...
    longHalfYears: string[] = ['I полугодие', 'II полугодие'];
    shortHalfYears: string[] = ['I пл', 'II пл'];
    ...
    shortQuarters: string[] = ['I квр', 'II квр', 'III квр', 'IV квр'];
    minQuarters: string[] = ['I кв', 'II кв', 'III кв', 'IV кв'];
