 ...
 * @param text - Строка, которую надо преобразовать.
 * @param requiredKeyboardLayout - На какую раскладку надо переключить. Двухсимвольный код языка. Например 'ru' или 'en'.
 * @param userKeyboardLayout - В какой раскладке строка передана. Используется для проверки доступности данной языковой раскладки.
 * @returns
 * @public
