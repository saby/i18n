...
/**
 * Класс локали, содержит конфигурации локали.
 * @public
...
class Locale implements ILocale {
     ...
     */
    timeInterval: (interval: ITimeUnits, format: LiteralTimeFormat) => string;
    ...
    /**
     * Описание социальных сетей доступных в регионе.
     */
     ...
     * @param langConfig Языковая конфигурация
     * @param regionConfig Региональная конфигурация
     */
    constructor(code: localeCode, langConfig: ILangConfig, regionConfig: IRegionConfig) {
        ...
        this.date = langConfig.dateTimeFormat || regionConfig.DateTimeFormats;
        this.ecosystem = regionConfig.Ecosystem;
        this.number = regionConfig.NumberFormat;
        this.socialNetworks = regionConfig.SocialNetworks;
        this.money = {
            symbol: regionConfig.Money.symbol,
            charCode: regionConfig.Money.charCode,
            currentCurrencyUnitDenominations: regionConfig.Money.currencyDenominations,
            ...
            currentCurrencySubunitDenominations: regionConfig.Money.subunitDenominations,
