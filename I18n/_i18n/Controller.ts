...
class Controller implements IController {
     ...
     */
    setLang(code: string, expires: number = EXPIRES_COOKIES) {
        // TODO Временное решение, мы должны жить на полной локале, пока не разделим конфигурации локалей на языковые и региональные.
        this.setLocale(code, expires);
    }
    ...
    _getLocaleCodeByLang(langCode) {
        ...
        // TODO Удалить, когда закроют проект https://online.sbis.ru/opendoc.html?guid=693d7c62-af3b-4246-a299-1aab884a4aaa&client=3
        return LOCALE_BY_LANG[langCode];
    }
