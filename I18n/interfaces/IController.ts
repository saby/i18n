...
export default interface IController {
    ...
    /**
     * Двухбуквенный код государственного языка для региона в котором мы находимся.
     * Если не удалось определить код региона, вернёт язык для региона RU, ru.
     * @example
     * <pre>
     *    import { controller } from 'I18n/i18n';
     *
     *     // Для региона RU
     *    controller.stateLanguage === 'ru' // true
     *    controller.stateLanguage === 'en' // false
     *
     *    // Для региона KZ
     *    controller.stateLanguage === 'kk' // true
     *    controller.stateLanguage === 'ru' // false
     * </pre>
     */
    stateLanguage: langCode;
