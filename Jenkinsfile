...
node ('controls') {
def version = "20.1000"
def workspace = "/home/sbis/workspace/i18n_${version}/${BRANCH_NAME}"
    dir (workspace){
        deleteDir()
        ...
        start = load "./jenkins_pipeline/platforma/branch/JenkinsfileI18n"
        ...
        timeout(time: 60, unit: 'MINUTES') {
			...
			try {
				...
				helper.time_stages(currentBuild, diff_time, "${BUILD_URL}", version, "i18n")
			}
        }
    }
}